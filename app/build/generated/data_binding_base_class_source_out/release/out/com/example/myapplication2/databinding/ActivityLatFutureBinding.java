...
public final class ActivityLatFutureBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLatFutureBinding(@NonNull ScrollView rootView, @NonNull Button btnSubmit,
  ...
  @NonNull
  public static ActivityLatFutureBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLatFutureBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_lat_future, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLatFutureBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLatFutureBinding((ScrollView) rootView, btnSubmit, progressBar,
