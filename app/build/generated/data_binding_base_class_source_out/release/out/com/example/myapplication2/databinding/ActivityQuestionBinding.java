...
public final class ActivityQuestionBinding implements ViewBinding {
  ...
  private ActivityQuestionBinding(@NonNull ScrollView rootView, @NonNull Button btnSubmit,
  ...
  public static ActivityQuestionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQuestionBinding((ScrollView) rootView, btnSubmit, progressBar,
