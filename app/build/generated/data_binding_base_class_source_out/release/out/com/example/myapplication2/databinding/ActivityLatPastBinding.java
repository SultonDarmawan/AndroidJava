...
public final class ActivityLatPastBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLatPastBinding(@NonNull ScrollView rootView, @NonNull Button btnSubmit,
  ...
  @NonNull
  public static ActivityLatPastBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLatPastBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_lat_past, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLatPastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLatPastBinding((ScrollView) rootView, btnSubmit, progressBar, tvOptionFour,
          tvOptionOne, tvOptionThree, tvOptionTwo, tvProgress, tvQuestion);
    }
