...
class LatFuture : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var binding : ActivityLatFutureBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLatFutureBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionLat.getQuestions3()
