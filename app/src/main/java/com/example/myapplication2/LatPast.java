...
public class LatPast extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLatPastBinding.inflate(getLayoutInflater());
    ...
    public void onClick(View view) {
        ...
        if (canSelectOption) {
            if (view.getId() == R.id.tvOptionOne) {
                selectedOptionView(binding.tvOptionOne, 1);
                buttonVisible();
            } else if (view.getId() == R.id.tvOptionTwo) {
                selectedOptionView(binding.tvOptionTwo, 2);
                buttonVisible();
            } else if (view.getId() == R.id.tvOptionThree) {
                selectedOptionView(binding.tvOptionThree, 3);
                buttonVisible();
            } else if (view.getId() == R.id.tvOptionFour) {
