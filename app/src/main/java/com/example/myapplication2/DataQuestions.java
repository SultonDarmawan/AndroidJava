...
public final class DataQuestions {
    ...
    public static ArrayList<Questions> getQuestions() {
        ...
        while (iterator.hasNext()) {
            ...
            question.setId(objectId[index]);
            question.setQuestion(objectQuestion[index]);
            ...
            question.setOptionOne((String) options.get(0));
            question.setOptionTwo((String) options.get(1));
            question.setOptionThree((String) options.get(2));
            question.setOptionFour((String) options.get(3));
            question.setAnswer(correctIndex = options.indexOf(objectOptionOne[index]) + 1);
