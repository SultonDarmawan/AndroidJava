...
class LatPresent : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var binding : ActivityLatPresentBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLatPresentBinding.inflate(layoutInflater)
